...
pub const EARTH_SEMI_MAJOR_AXIS: Length = Length::from_meters(149_598_023_000.0);
...
pub const JUPITER_SEMI_MAJOR_AXIS: Length = Length::from_meters(778_479_000_000.0);
...
pub const MOON_SEMI_MAJOR_AXIS: Length = Length::from_meters(384_399_000.0);
pub const MOON_RADIUS: Length = Length::from_meters(1_737_400.0);
