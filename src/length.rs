...
pub(super) static EARTH_RADII_PER_METER: Float = 1.0 / METERS_PER_EARTH_RADIUS;
static METERS_PER_JUPITER_RADIUS: Float = 69_911_000.0;
pub(super) static JUPITER_RADII_PER_METER: Float = 1.0 / METERS_PER_JUPITER_RADIUS;
static METERS_PER_SUN_RADIUS: Float = 695_700_000.0;
pub(super) static SUN_RADII_PER_METER: Float = 1.0 / METERS_PER_SUN_RADIUS;
