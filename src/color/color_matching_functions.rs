...
pub(crate) fn x_color_matching(lambda: Distance<Float>) -> Float {
...
pub(crate) fn convolute_with_black_body(
    fun: Box<dyn Fn(Distance<Float>) -> Float>,
