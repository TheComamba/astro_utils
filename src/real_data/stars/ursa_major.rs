...
fn alioth() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(4.14)),
...
fn dubhe() -> RealData {
    RealData {
        ...
        constellation: "Ursa Major",
        radius: Some(Length::new::<solar_radius>(17.03)),
...
fn merak() -> RealData {
    RealData {
        ...
        constellation: "Ursa Major",
        radius: Some(Length::new::<solar_radius>(3.021)),
...
fn phecda() -> RealData {
    RealData {
        ...
        constellation: "Ursa Major",
        radius: Some(Length::new::<solar_radius>(3.04)),
