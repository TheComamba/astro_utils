...
fn sirius() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(1.711)),
...
fn adhara() -> RealData {
    RealData {
        ...
        constellation: "Canis Major",
        radius: Some(Length::new::<solar_radius>(13.9)),
...
fn wezen() -> RealData {
    RealData {
        ...
        constellation: "Canis Major",
        radius: Some(Length::new::<solar_radius>(215.)),
...
fn mirzam() -> RealData {
    RealData {
        ...
        constellation: "Canis Major",
        radius: Some(Length::new::<solar_radius>(9.7)),
...
fn aludra() -> RealData {
    RealData {
        ...
        constellation: "Canis Major",
        radius: Some(Length::new::<solar_radius>(54.)),
