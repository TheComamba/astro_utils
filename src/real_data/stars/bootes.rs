...
fn arcturus() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(25.4)),
...
fn izar() -> RealData {
    RealData {
        ...
        constellation: "Boötes",
        radius: Some(Length::new::<solar_radius>(33.)),
...
fn gamma_bootis() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(5.16)),
...
fn delta_bootis() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(10.5)),
...
fn beta_bootis() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(21.5)),
...
fn muphrid() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(2.672)),
