...
fn polaris() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(37.5)),
...
fn kochab() -> RealData {
    RealData {
        ...
        constellation: "Ursa Minor",
        radius: Some(Length::new::<solar_radius>(42.06)),
...
fn zeta_ursae_minoris() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(6.15)),
...
fn delta_ursae_minoris() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(2.8)),
...
fn eta_ursae_minoris() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(2.0)),
