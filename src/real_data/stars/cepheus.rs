...
fn alfirk() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(5.6)),
...
fn errai() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(4.93)),
...
fn delta_cepheri() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(44.5)),
...
fn eta_cephei() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(4.12)),
...
fn iota_cephei() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(11.08)),
...
fn zeta_cephei() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(94.)),
...
fn erakis() -> RealData {
    RealData {
        ...
        constellation: "Cepheus",
        radius: Some(Length::new::<solar_radius>(972.)),
