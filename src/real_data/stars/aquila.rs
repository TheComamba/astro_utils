...
fn altair() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(1.63)),
...
fn tarazed() -> RealData {
    RealData {
        ...
        constellation: "Aquila",
        radius: Some(Length::new::<solar_radius>(91.82)),
...
fn theta_aquilae() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(4.76)),
...
fn delta_aquilae() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(2.04)),
