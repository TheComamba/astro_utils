...
fn antares() -> RealData {
    RealData {
        ...
        radius: Some(Length::new::<solar_radius>(680.)),
...
fn shaula() -> RealData {
    RealData {
        ...
        constellation: "Scorpius",
        radius: Some(Length::new::<solar_radius>(8.8)),
...
fn sargas() -> RealData {
    RealData {
        ...
        constellation: "Scorpius",
        radius: Some(Length::new::<solar_radius>(26.3)),
...
fn dschubba() -> RealData {
    RealData {
        ...
        constellation: "Scorpius",
        radius: Some(Length::new::<solar_radius>(6.7)),
...
fn larawag() -> RealData {
    RealData {
        ...
        constellation: "Scorpius",
        radius: Some(Length::new::<solar_radius>(12.6)),
