...
use crate::{
    stars::{
        ...
        random::random_stars::{DIMMEST_ILLUMINANCE, METALLICITY_INDEX},
    },
    units::{
...
impl Trajectory {
    ...
    pub(super) fn to_star(&self, age: Time<f64>, pos: Cartesian) -> StarData {
        ...
        let lifestage_evolution = get_lifestage_evolution_old(&star, other_star);
...
fn get_lifestage_evolution_old(
    star: &StarData,
    other_star: StarData,
